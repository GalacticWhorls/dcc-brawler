...
### The Hoarder — spawner siege *(v0.9)*
...
### The Juicer — roided gym lizard *(v0.10+)*
...
→ Hoarder's lair *(v0.9)* → approach + Juicer *(v0.10+)* → Ball of Swine *(later)*.
...
3. **v0.9** — The Hoarder (spawner, smashable piles, swell→poison cloud, huge HP).
4. **v0.10+** — Small Lizard mob + Juicer approach; then the Juicer.
5. **later** — Ball of Swine boss; then playable characters (Donut/Florin/Elle), one
