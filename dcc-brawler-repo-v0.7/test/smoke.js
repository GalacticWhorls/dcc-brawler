...
js += ";globalThis.__T={update,game,Enemy,Dozer,RotSticker,makeEnemy,keys,PRESS,DEPTH_TOL,W,MAX_ATTACKERS};";
try { eval(js); }
catch (e) { console.error("[FAIL] index.html script did not load:\n" + (e && e.stack || e)); process.exit(1); }
const { update, game, Enemy, Dozer, RotSticker, makeEnemy, keys, PRESS, DEPTH_TOL, W, MAX_ATTACKERS } = globalThis.__T;
